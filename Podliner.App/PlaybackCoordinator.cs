...
public sealed class PlaybackCoordinator : IDisposable
{
    ...
    private readonly Podliner.App.Services.IEpisodeStore _episodes;
    private readonly Podliner.App.Services.IQueueService _queue;
    private readonly Podliner.App.Services.IFeedStore? _feedStore;

    public PlaybackCoordinator(AppData data, IAudioPlayer audioPlayer, Func<Task> saveAsync, MemoryLogSink mem,
                               Podliner.App.Services.IEpisodeStore episodes,
                               Podliner.App.Services.IQueueService queue,
                               Podliner.App.Services.IFeedStore? feedStore = null)
    {
